...
export default function connectSource() {
  ...
  return (
    <div>
      <Head>
        <title>Connect Source Wallet</title>
              ...
              <form className="mx-auto mb-5">
                <div className="d-flex w-100 px-4 pt-4 pb-2">
                  <div className="w-50 text-center">
                    <span className="badge rounded-pill bg-primary mr-2">1</span> Connect source wallet
                  </div>
                  <div className="w-50 text-center transparent">
                    <span className="badge rounded-pill bg-base-300 text-dark mr-2">2</span> Connect destination wallet
                  </div>
                </div>
